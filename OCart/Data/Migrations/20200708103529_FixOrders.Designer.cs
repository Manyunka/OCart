...
namespace OCart.Data.Migrations
{
    ...
    [Migration("20200708103529_FixOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OCart.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OCart.Models.OrderFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("OrderMessageId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrderMessageId");

                    b.ToTable("OrderFiles");
                });

            modelBuilder.Entity("OCart.Models.OrderMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OCart.Models.AuctionOrder", b =>
                {
                    b.HasBaseType("OCart.Models.Order");
                    ...
                    b.HasDiscriminator().HasValue("AuctionOrder");
                });
            ...
            modelBuilder.Entity("OCart.Models.CommissionOrder", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("CommissionOrder");
                });
            ...
            modelBuilder.Entity("OCart.Models.OrderFile", b =>
                {
                    b.HasOne("OCart.Models.OrderMessage", "OrderMessage")
                        .WithMany("OrderFiles")
                        .HasForeignKey("OrderMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("OCart.Models.OrderMessage", b =>
                {
                    ...
                    b.HasOne("OCart.Models.AuctionOrder", "Order")
                        .WithMany()
