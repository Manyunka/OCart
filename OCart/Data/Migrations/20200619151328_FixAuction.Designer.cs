...
namespace OCart.Data.Migrations
{
    ...
    [Migration("20200619151328_FixAuction")]
    partial class FixAuction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OCart.Models.Auction", b =>
                {
                    ...
                    b.Property<decimal>("InitialCostBet")
                    ...
                    b.HasIndex("WinBetId")
                        .IsUnique()
                        .HasFilter("[WinBetId] IS NOT NULL");
            ...
            modelBuilder.Entity("OCart.Models.AuctionPicture", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OCart.Models.Auction", b =>
                {
                    ...
                    b.HasOne("OCart.Models.Bet", "WinBet")
                        .WithOne("Auction")
                        .HasForeignKey("OCart.Models.Auction", "WinBetId");
                });
            ...
            modelBuilder.Entity("OCart.Models.Bet", b =>
                {
                    b.HasOne("OCart.Models.Auction", null)
                        .WithMany("Bets")
                        .HasForeignKey("AuctionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OCart.Models.Dialog", b =>
                {
                    b.HasOne("OCart.Models.ApplicationUser", "Interlocutor")
                        .WithMany()
